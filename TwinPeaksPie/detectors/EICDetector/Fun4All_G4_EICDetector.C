...
//    const string &inputFile = "https://www.phenix.bnl.gov/WWW/publish/phnxbld/sPHENIX/files/sPHENIX_G4Hits_sHijing_9-11fm_00000_00010.root",
    const string &outputFile = "G4EICDetector_test.root",
    ...
    const string &outdir = ".")
{
  ...
  if (Input::SIMPLE)
  {
    ...
    INPUTGENERATOR::SimpleEventGenerator[0]->set_pt_range(5.0, 20.);
  }
  // Upsilons
  ...
  if (Input::GUN)
  {
    INPUTGENERATOR::Gun[0]->AddParticle("e-", 0, 1, 0);
  ...
  G4TRACKING::PROJECTION_HCALOUT = false;
  G4TRACKING::PROJECTION_FEMC = false;
  G4TRACKING::PROJECTION_FHCAL = false;
  G4TRACKING::PROJECTION_LFHCAL = false;
