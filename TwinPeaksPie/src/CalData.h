...
class CalData : public SubsysReco
{
 public:
  /// Constructor
  CalData(const std::string &name = "CalData",
              const std::string &fname = "CalData.root");
 ...
 // std::vector<double> m_mincluspt;
  ...
  /// EMCal Cluster variables
  std::vector<double> m_clusenergy;
  std::vector<double> m_cluseta;
  std::vector<double> m_clustheta;
  std::vector<double> m_cluspt;
  std::vector<double> m_clusphi;
  std::vector<double> m_cluspx;
  std::vector<double> m_cluspy;
  std::vector<double> m_cluspz;
  std::vector<double> m_E_4x4;

  ///HCal Cluster variables
  std::vector<double> m_clusenergy_HCal;
  std::vector<double> m_clusphi_HCal;
  std::vector<double> m_cluseta_HCal;
  std::vector<double> m_cluspt_HCal;

  std::vector<double> m_clusenergy_HCalOUT;
  std::vector<double> m_clusphi_HCalOUT;
